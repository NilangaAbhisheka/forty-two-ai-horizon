      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="inline-flex items-center glass px-4 py-2 rounded-full mb-8 animate-pulse-glow">
            <span className="text-sm font-medium gradient-text">✨ The Future of AI is Here</span>
          </div>
          ...
          <p className="text-xl md:text-2xl text-foreground/80 mb-8 max-w-3xl mx-auto leading-relaxed">
            AI solutions that redefine efficiency and unlock unprecedented growth for modern businesses.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-2xl mx-auto">
            <div className="glass-dark rounded-lg p-6 hover:glow-blue transition-all duration-300">
              ...
              <div className="text-foreground/60">AI Models Deployed</div>
            </div>
            ...
            <div className="glass-dark rounded-lg p-6 hover:glow-blue transition-all duration-300">
              ...
              <div className="text-foreground/60">AI Support</div>
            </div>
          </div>
        </div>
      </div>
