...
const Technologies = () => {
  const techCategories = [
    ...
    },
    {
      ...
      technologies: ['Python', 'JavaScript', 'TypeScript', 'Go', 'Rust', 'SQL'],
    },
    {
      title: 'Data & Analytics',
      technologies: ['Apache Spark', 'PostgreSQL', 'MongoDB', 'Redis', 'Elasticsearch', 'Apache Kafka'],
    },
    {
      title: 'Web Technologies',
      technologies: ['React', 'Node.js', 'FastAPI', 'GraphQL', 'WebSocket', 'REST APIs'],
    },
    {
      title: 'DevOps & Tools',
      technologies: ['GitHub Actions', 'Jenkins', 'Prometheus', 'Grafana', 'ELK Stack', 'MLflow'],
    },
  ];
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-foreground/80 max-w-3xl mx-auto">
            ...
            robust, scalable, and innovative AI solutions.
          </p>
        </div>
        ...
        <div className="glass rounded-2xl p-8 text-center">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center space-y-8 md:space-y-0 md:space-x-8">
            {[
              { step: '01', title: 'Data Collection', desc: 'Gather & preprocess data' },
              { step: '02', title: 'Model Training', desc: 'Train & optimize AI models' },
              { step: '03', title: 'Deployment', desc: 'Deploy to production' },
              { step: '04', title: 'Monitoring', desc: 'Continuous monitoring & improvement' },
            ].map((item, index) => (
